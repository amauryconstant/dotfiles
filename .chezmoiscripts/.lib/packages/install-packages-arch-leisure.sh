...
# Purpose: Install packages for Arch Linux leisure destination
...
readonly SCRIPT_PURPOSE="Install packages for Arch Linux leisure destination"
...
# Category installation functions (leisure-focused)
install_fonts() {
    log_info "Installing fonts for leisure environment"
...
install_terminal_essentials() {
    log_info "Installing terminal essentials for leisure environment"
...
install_terminal_utils() {
    log_info "Installing terminal utilities for leisure environment"
...
install_terminal_presentation() {
    log_info "Installing terminal presentation tools for leisure environment"
...
install_general_software() {
    log_info "Installing general software for leisure environment"
    
    local packages="firefox chromium spotify nextcloud-client qbittorrent"
    local strategy="pacman,yay_bin"  # Binary strategy for leisure
...
install_system_software() {
    log_info "Installing system software for leisure environment"
...
install_printing_scanning() {
    log_info "Installing printing and scanning software for leisure environment"
...
main() {
    ...
    log_info "Processing $(echo "${CATEGORIES[@]}" | wc -w) package categories for leisure destination"
