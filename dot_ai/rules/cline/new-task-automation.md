...
# New Task Automation: Context Window Management
...
### **MUST** Monitor Context Window Usage
...
## Task Implementation and Handoff Process
...
## Detailed Context Transfer Requirements
...
### Example of an Ineffective Task Handoff:

An ineffective handoff might lack critical details in 'Current State' or 'Next Steps', making it difficult for the next session to continue the work efficiently. Always ensure your handoffs are comprehensive and actionable.
...
You **MUST** monitor the context window usage in the environment details section. When it exceeds 50% (e.g., "105,000 / 200,000 tokens (53%)"), you **MUST** proactively initiate the task handoff process using the `ask_followup_question` tool followed by the `new_task` tool.
