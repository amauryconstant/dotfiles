...
- Templates: `hyprland.{conf,lua}.tmpl`, `hyprlock.conf.tmpl`, `hypridle{,-nolock}.conf.tmpl`, `conf/monitor.{conf,lua}.tmpl`, `conf/environment.{conf,lua}.tmpl`, `conf/bindings/applications.{conf,lua}.tmpl`, `conf/bindings/voice.{conf,lua}.tmpl`
