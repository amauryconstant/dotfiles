...
-- ----------------------------------------------------------------------------
-- NVIDIA-specific settings (nvidia-open drivers) — DESKTOP ONLY
-- ----------------------------------------------------------------------------
-- These variables enable proper Wayland support with NVIDIA GPUs on desktop.
-- Desktop has a discrete GPU only; laptop has hybrid GPU and uses auto-detect.
