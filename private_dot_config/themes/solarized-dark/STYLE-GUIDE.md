...
**Base16 mapping**: [base16-solarized-dark](https://github.com/scaryrawr/base16-opencode) | [OPENCODE.md](./OPENCODE.md)
- `bg-primary` → `base00` (#002b36 - Solarized base03)
- `bg-secondary` → `base01` (#073642 - Solarized base02)
- `bg-tertiary` → `base02` (#586e75 - Solarized base01)
